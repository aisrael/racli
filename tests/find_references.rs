...
/// Integration test: gRPC `FindReferences` resolves `RustAnalyzerSession` in `src/server.rs` to its multiple usages.
#[tokio::test]
async fn grpc_find_references_rust_analyzer_session() {
